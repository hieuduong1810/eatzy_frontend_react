...
const DriverRegisterPage = () => {
    ...
    if (isSuccess) {
        return (
            <AuthLayout
                appName="Tài xế Eatzy"
                badgeColor="linear-gradient(135deg, #F59E0B, #D97706)"
                subtitle="Đăng ký làm tài xế, tự do thu nhập và thời gian"
            >
                <div style={{ textAlign: "center", padding: "var(--space-8) 0" }}>
                    ...
                    <p className="auth-form-subtitle" style={{ marginBottom: "var(--space-8)" }}>
                        Tài khoản tài xế của bạn đã được tạo thành công
                    </p>
                    <button
    ...
    return (
        ...
        >
            ...
            <div className="auth-form-header">
                <h2 className="auth-form-title">Đăng ký tài xế</h2>
                <p className="auth-form-subtitle">Tạo tài khoản để bắt đầu nhận đơn hàng</p>
            </div>
