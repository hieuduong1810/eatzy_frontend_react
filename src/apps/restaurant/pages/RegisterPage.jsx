            ...
            >
                <div style={{ textAlign: "center", padding: "var(--space-8) 0" }}>
                    <div style={{
                        ...
                        background: "linear-gradient(135deg, #F55555, #DC2626)",
                        display: "flex", alignItems: "center", justifyContent: "center",
                        margin: "0 auto var(--space-6)",
                        boxShadow: "0 8px 30px rgba(245, 85, 85, 0.3)",
    ...
    return (
        ...
        >
            ...
            <div className="auth-form-header">
                <h2 className="auth-form-title">Đăng ký nhà hàng</h2>
                <p className="auth-form-subtitle">Tạo tài khoản để bắt đầu bán hàng trên Eatzy</p>
            </div>
